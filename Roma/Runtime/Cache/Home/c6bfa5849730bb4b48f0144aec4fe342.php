...
<body>
	<div class="con_mid w1000">
			...
			<div class="tt">
	 <p class="fright"><a href="">首页</a><img src="/Public/Images/sanjiao.png" class="mr-5 ml-5"><a href="">公司新闻</a><img src="/Public/Images/sanjiao.png" class="mr-5 ml-5"><a href="">行业动态</a></p>

	 </div>

	  <div class="con_l fl">
	        	<dl>
	        		<dt><img src="/Public/Images/row.png" alt=""class="mr-5">公司新闻<span>&nbsp;&nbsp;&nbsp;/&nbsp;NEWS</span></dt>
	        		<div class="clearxd"></div>
	        		<dd class="mr"><a href="javascript:;">公司新闻</a></dd>
	        		<dd><a href="javascript:;">行业动态</a></dd>
	    ...
	    <div class="con_r fr news">
	      <ul class="news-ul">
	      		<li class="pb-10 clear">
	      			<div class="fl left">
	      				<a href="javascript:;">
	      					<img src="/Public/images/news-gg1.png" alt="">
	      				</a>
	      			</div>
	      			<div class="fr right">
	      				<h4 class="news-title pr">
	      				罗马国际介绍
	      				<span class="pa" style="right:0; color:#1a1a1a; font-size:14px;">2015-4-3</span>
	      				</h4>

						<p>罗马布艺连锁机构成立于1999年，是由罗马国际集团有限公司（香港）独资的专业从事家居布艺产品设计、生产、销售、服务于一体的公司。多年来一直以“创国际优质布艺品牌”为发展目标，现已发展成为拥有50家自营连锁店......</p>
	      ...
	      <div class="page-list">
	      	<a class="pre-a mr-5" href="javascript:;">上一页</a>
	      	<span class="page-sp">
		      	<a class="mr-a" href="javascript:;">1</a>
		      	<a href="javascript:;">2</a>
		      	<a href="javascript:;">3</a>
		    </span>
	      	<a class="ml-5" href="javascript:;">下一页</a>
	      	<span class="page-msg ml-5 mr-5">
	      		共5页
	      	</span>
	      	<span class="page-jump">
			 	到第
			 	<input  class="jump-text tc" type="text" >
			 	页
	      	</span>
